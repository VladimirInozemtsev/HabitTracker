...
const darkTheme = {
  colors: {
    ...
    // ФОНОВЫЕ ЦВЕТА
    background: '#1a1a1a',     // Серый фон
    surface: '#1a1a1a',       // Поверхности карточек
    card: '#000000',           // Карточки привычек
...
const lightTheme = {
  colors: {
    ...
    // ФОНОВЫЕ ЦВЕТА
    background: '#F4E4BC',     // Топленое молоко фон (темнее)
    surface: '#E8D5B7',       // Бежевые поверхности (темнее)
    card: '#F4E4BC',           // Бежевые карточки (темнее)
    ...
    // НАВИГАЦИЯ
    navigation: {
      background: '#E8D5B7',   // Бежевый фон навигации (темнее)
      active: '#000000',       // Активный элемент (черный)
      inactive: '#999999',     // Неактивный элемент (серый)
      border: '#D4C4A8',       // Бежевые границы навигации (темнее)
    },
